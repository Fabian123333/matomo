...
(function ($) {
        ...
        if (gd.length) {
            ...
            if (this.markerRenderer.show && !fill) {
                ...
                for (i = 0; i < gd.length; i++) {
                    ...
                    markerOptions.incompletFillColor = plot.grid.background;
    ...
    $.jqplot.ShapeRenderer.prototype.draw = function(ctx, points, options) {
        ...
        if (isarc) {
            ...
            if (opts.isIncomplete && opts.incompletFillColor) {
                ctx.beginPath();
                ctx.arc(points[0], points[1], points[2] / 8, points[3], points[4], true);
                ctx.strokeStyle = opts.incompletFillColor;
                ctx.stroke();
                ctx.closePath();
            }
        ...
        // draw full lines for complete data points
        for (let i = 0; i < points.length; i++) {
            ...
            ctxPattern.moveTo(points[prev][0], points[prev][1]);
    ...
    $.jqplot.ShadowRenderer.prototype.draw = function(ctx, points, options) {
        ...
        for (let j= 0; j < depth; j++) {
            ...
            if (isarc) {
                ...
                for (let i = 0; i < points.length; i++) {
                    if (incompleteDataPoints.includes(i)) {
                        // do not render shadow for lines leading up to an incomplete data point
                        continue;
                    }
